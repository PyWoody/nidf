...
Simple, striped down `find` replacement for use on NAS or slow disk drives. Results will be may be faster to `find` on SSDs for deep but not shallow searches. 
